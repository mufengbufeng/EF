---
name: ef-event-system
description: Reference codebase for Event. Use this skill when you need to understand the structure, implementation patterns, or code details of the Event project.
---

# Event Codebase Reference

6 files | 451 lines | 3498 tokens
