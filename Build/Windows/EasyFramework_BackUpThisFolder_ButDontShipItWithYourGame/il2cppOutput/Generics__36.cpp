...
IL_0009:
	...
	try
	{
		...
		try
		{
			RuntimeObject* L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m4214AB69CDA9A49B1BA16B7F31F68487470682FB(__this, L_3, ((*(SystemTypeIndex_tF8FE523E862B9185701A867D7FD36966F8F03E59*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 67));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
